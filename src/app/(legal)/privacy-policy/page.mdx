# Privacy Policy for ReviewInsight

## Introduction

Welcome to ReviewInsight, the **AI-powered app review analysis platform** designed to help you gain insights from millions of app store and social media reviews. At ReviewInsight, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using ReviewInsight:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use ReviewInsight, including your interactions, features accessed, usage frequency, and app analysis queries.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access ReviewInsight, such as device type, operating system, and browser type.
...
6. **App Analysis Data**
   - **What We Collect**: Information about the apps you search for and analyze, including app names, categories, and analysis preferences.
   - **Purpose**: To provide personalized insights and improve our AI analysis capabilities.
...
**Website**: [reviewinsight.app](https://reviewinsight.app)
**Email**: [support@reviewinsight.app](mailto:support@reviewinsight.app)

By using ReviewInsight, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
