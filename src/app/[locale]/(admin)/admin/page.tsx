...
export default async function () {
  ...
  const allDates = new Set([...(orders ? Array.from(orders.keys()) : []), ...(users ? Array.from(users.keys()) : [])]);
        ...
        <div className="@container/main flex flex-1 flex-col gap-2">
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
            ...
            <div className="px-4 lg:px-6">
              <DataCharts data={data} fields={fields} title="Users and Orders Overview" description="Daily users and orders data" defaultTimeRange="90d" />
            </div>
          </div>
        </div>
      </div>
