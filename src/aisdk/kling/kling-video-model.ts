...
export class KlingVideoModel implements VideoModelV1 {
  ...
  constructor(modelId: KlingVideoModelId, settings: KlingVideoSettings, config: KlingVideoModelConfig) {
  ...
  async doGenerate({
    ...
    headers,
    abortSignal,
  }: Parameters<VideoModelV1["doGenerate"]>[0]): Promise<Awaited<ReturnType<VideoModelV1["doGenerate"]>>> {
