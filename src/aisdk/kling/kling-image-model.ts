...
export class KlingImageModel implements ImageModelV1 {
  ...
  constructor(modelId: KlingImageModelId, settings: KlingImageSettings, config: KlingImageModelConfig) {
  ...
  async doGenerate({
    ...
    headers,
    abortSignal,
  }: Parameters<ImageModelV1["doGenerate"]>[0]): Promise<Awaited<ReturnType<ImageModelV1["doGenerate"]>>> {
