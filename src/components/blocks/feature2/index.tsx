                  ...
                  <>
                    ...
                    <div className="p-6 bg-gradient-to-br from-indigo-50/50 to-purple-50/50">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div
                            className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(item.children[0].label || "")}`}
                          >
                    ...
                    <div className="p-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div
                            className={`inline-flex px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(item.children[1].label || "")}`}
                          >
