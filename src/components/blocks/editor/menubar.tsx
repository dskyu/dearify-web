...
export default function Menubar() {
  ...
  return (
    <div className="flex flex-wrap gap-1 p-2 border-b mb-4">
      ...
      <button type="button" onClick={() => editor.chain().focus().unsetAllMarks().run()} className="p-2 rounded hover:bg-gray-100" title="Clear marks">
      ...
      <button
        ...
        className={`p-2 rounded hover:bg-gray-100 ${editor.isActive("heading", { level: 4 }) ? "bg-gray-100" : ""}`}
        title="Heading 4"
      >
      ...
      <button
        ...
        className={`p-2 rounded hover:bg-gray-100 ${editor.isActive("heading", { level: 5 }) ? "bg-gray-100" : ""}`}
        title="Heading 5"
      >
      ...
      <button
        ...
        className={`p-2 rounded hover:bg-gray-100 ${editor.isActive("heading", { level: 6 }) ? "bg-gray-100" : ""}`}
        title="Heading 6"
      >
      ...
      <button type="button" onClick={() => editor.chain().focus().setHorizontalRule().run()} className="p-2 rounded hover:bg-gray-100" title="Horizontal rule">
        <Minus className="w-4 h-4" />
      </button>
      <button type="button" onClick={() => editor.chain().focus().setHardBreak().run()} className="p-2 rounded hover:bg-gray-100" title="Hard break">
      ...
      <button
        ...
        className={`p-2 rounded hover:bg-gray-100 ${editor.isActive("textStyle", { color: "#958DF1" }) ? "bg-gray-100" : ""}`}
        title="Purple"
      >
