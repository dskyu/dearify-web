  ...
  return (
    <>
      ...
      <div className="w-full px-4 md:px-8 py-8">
        ...
        {table.description && <p className="text-sm text-muted-foreground mb-8">{table.description}</p>}
        {table.tip && <p className="text-sm text-muted-foreground mb-8">{table.tip.description || table.tip.title}</p>}
