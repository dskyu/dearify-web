...
import { getUuid, hashPassword, verifyPassword } from "@/lib/hash";
import { saveUser } from "@/services/user";
import { findUserByEmail, findUserByEmailAndPassword } from "@/models/user";
  ...
  CredentialsProvider({
    ...
    async authorize(credentials) {
      ...
      try {
        ...
        const user = await findUserByEmailAndPassword(email, hashedPassword);
